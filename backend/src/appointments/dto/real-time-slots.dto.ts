...
export class GetRealTimeSlotsDto {
    ...
    @ApiProperty({
        description: 'ID del tipo de servicio (opcional, si no se especifica se usan todos)',
        example: 1,
        required: false
    })
    @IsOptional()
    ...
    @ApiProperty({
        description: 'Duración personalizada en minutos (opcional, si no se especifica se usa la del servicio)',
        example: 60,
        required: false,
        minimum: 15,
        maximum: 480
...
export class RealTimeSlotDto {
    ...
    @ApiProperty({
        description: 'Si el slot puede acomodar completamente el servicio solicitado',
        example: true
    })
