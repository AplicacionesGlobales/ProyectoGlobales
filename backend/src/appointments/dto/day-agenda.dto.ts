...
export class AgendaSlotDto {
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Si este slot está disponible para nuevas citas',
  })
  isBookable?: boolean;
}
...
export class BusinessHoursDto {
  ...
  @ApiProperty({
    example: false,
    description: 'Si el negocio está cerrado este día',
  })
  isClosed: boolean;
}
...
export class DayAgendaDto {
  ...
  @ApiProperty({
    example: 12,
    description: 'Número total de espacios disponibles para el día',
  })
  totalAvailableSlots: number;

  @ApiProperty({
    example: 30,
    description: 'Duración predeterminada de slot en minutos',
  })
  slotDuration: number;

  @ApiProperty({
    example: 240,
    description: 'Tiempo total disponible en minutos',
  })
  totalAvailableTime: number;

  @ApiProperty({
    example: 150,
    description: 'Tiempo total reservado en minutos',
  })
