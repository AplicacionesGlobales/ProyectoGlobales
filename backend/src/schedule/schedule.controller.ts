...
export class ScheduleController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna los horarios regulares de operación para cada día de la semana',
  })
  ...
  async getBusinessHours(
    ...
    return this.scheduleService.getBusinessHours(
      parseInt(brandId),
      req.user.userId,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Actualiza los horarios regulares de operación para cada día de la semana',
  })
  @ApiParam({ name: 'brandId', description: 'ID del brand', example: 456 })
  ...
  @ApiOperation({
    ...
    description:
      'Configura los horarios laborales por primera vez para el brand. Solo funciona si no hay horarios previamente configurados.',
  })
  @ApiParam({ name: 'brandId', description: 'ID del brand', example: 456 })
  @ApiBody({ type: UpdateBusinessHoursDto })
  @ApiResponse({
  ...
  @ApiResponse({
    status: 409,
    description:
      'Los horarios ya están configurados. Use PUT /business-hours para actualizar.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Crea una nueva excepción en el horario regular (días festivos, vacaciones, etc.)',
  })
  @ApiParam({ name: 'brandId', description: 'ID del brand', example: 456 })
