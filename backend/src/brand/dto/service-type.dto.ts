...
export class AppointmentSettingsDto {
  ...
  @ApiProperty({ example: true, description: 'Si usa tipos de servicio personalizados' })
  ...
  @ApiProperty({ example: 30, description: 'Días máximos de anticipación para reservar' })
  maxAdvanceBookingDays: number;

  @ApiProperty({ example: 2, description: 'Horas mínimas de anticipación para reservar' })
