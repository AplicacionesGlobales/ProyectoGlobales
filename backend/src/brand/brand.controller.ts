...
export class BrandController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna toda la información del brand incluyendo usuarios, features, plan, etc.',
  })
  ...
  async getBrandAdmin(
    ...
    return this.brandService.getBrandAdminInfo(
      parseInt(brandId),
      req.user.userId,
    );
  }
  ...
  async createBrandUser(
    ...
    return this.brandService.createBrandUser(
      parseInt(brandId),
      createUserDto,
      req.user.userId,
    );
  ...
  async updateBrandFeatures(
    ...
    return this.brandService.updateBrandFeatures(
      parseInt(brandId),
      featureIds,
      req.user.userId,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Retorna información completa del plan actual, historial y opciones de upgrade',
  })
  @ApiParam({ name: 'brandId', description: 'ID del brand', example: 456 })
  @ApiResponse({
    status: 200,
  ...
  async getBrandPlan(
    ...
    return this.brandService.getBrandPlanDetails(
      parseInt(brandId),
      req.user.userId,
    );
  }
  ...
  async updateBrandPlan(
    ...
    return this.brandService.updateBrandPlan(
      parseInt(brandId),
      updatePlanDto,
      req.user.userId,
    );
  ...
  async getBrandStats(
    ...
    return this.brandService.getBrandStats(
      parseInt(brandId),
      period,
      req.user.userId,
    );
  ...
  @ApiQuery({
    ...
    example: 'all',
    description:
      'Filtrar por estado (all, pending, completed, failed, cancelled)',
  })
  @ApiResponse({
    status: 200,
