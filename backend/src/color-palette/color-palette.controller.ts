...
export class ColorPaletteController {
  ...
  async createColorPalette(
    @Body() createDto: CreateColorPaletteDto,
  ...
  async updateColorPaletteByBrand(
    ...
    return this.colorPaletteService.updateColorPaletteByBrandId(
      brandId,
      updateDto,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Create a new color palette or update existing one for a brand (upsert operation)',
  })
  @ApiParam({
    name: 'brandId',
    description: 'Brand ID',
  ...
  async validateColorPalette(
    @Body() palette: ColorPaletteValidationDto,
  ): Promise<BaseResponseDto> {
