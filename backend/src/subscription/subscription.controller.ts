...
export class SubscriptionController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna las funcionalidades/servicios actualmente activos en la suscripción del usuario autenticado',
  })
  @ApiResponse({
    status: 200,
  ...
  async getMySubscriptionFeatures(
    ...
    return this.subscriptionService.getUserSubscriptionFeatures(
      req.user.userId,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Procesa la activación de una nueva funcionalidad para la marca del usuario autenticado, validando el pago correspondiente',
  })
  @ApiResponse({
    status: 200,
  ...
  async activateFeature(
    ...
    return this.subscriptionService.activateFeature(
      req.user.userId,
      activateFeatureDto,
    );
  }
