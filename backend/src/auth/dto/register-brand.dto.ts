...
class ColorPaletteDto {
  ...
  @IsHexColor({
    message: 'Color primario debe ser un color hexadecimal válido',
  })
  ...
  @IsHexColor({
    message: 'Color secundario debe ser un color hexadecimal válido',
  })
  ...
  @IsHexColor({
    message: 'Color de acento debe ser un color hexadecimal válido',
  })
  @IsNotEmpty({ message: 'Color de acento es requerido' })
  accent: string;

  @ApiProperty({
    description: 'Color neutral en formato hexadecimal',
    example: '#6B7280',
  })
  ...
  @ApiProperty({
    description: 'Color de éxito en formato hexadecimal',
    example: '#10B981',
  })
  @IsHexColor({
    message: 'Color de éxito debe ser un color hexadecimal válido',
  })
...
class UserInfoDto {
  @ApiProperty({
    description: 'Email del usuario ROOT',
...
class BrandInfoDto {
  @ApiProperty({
    ...
    example: 'Mi Fotografía Profesional',
  })
  @IsString({ message: 'Nombre de la marca debe ser texto' })
  @IsNotEmpty({ message: 'Nombre de la marca es requerido' })
  @MinLength(2, {
    message: 'Nombre de la marca debe tener al menos 2 caracteres',
  })
  name: string;

  @ApiPropertyOptional({
    description: 'Descripción de la marca',
    example: 'Servicios profesionales de fotografía para eventos especiales',
  })
  @IsOptional()
...
export class RegisterBrandDto {
  @ApiProperty({
    description:
      'Información del usuario ROOT que será propietario de la marca',
    type: UserInfoDto,
  })
  @ValidateNested()
  @Type(() => UserInfoDto)
  ...
  @ApiProperty({
    description: 'Información de la marca a crear',
    type: BrandInfoDto,
  })
  @ValidateNested()
  @Type(() => BrandInfoDto)
  ...
  @ApiProperty({
    description: 'Paleta de colores para la marca',
  ...
  @IsString({
    each: true,
    message: 'Cada función debe ser una cadena de texto',
  })
