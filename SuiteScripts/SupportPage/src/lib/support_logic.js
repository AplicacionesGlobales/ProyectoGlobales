...
define(["require", "exports"], function (require, exports) {
    ...
    exports.renderAgendaPage = exports.renderTicketsPage = exports.renderPage = exports.renderRecentTicketsCard = exports.withLang = exports.normLang = exports.escapeHtml = void 0;
    const MSG_MAX = 2000;
    const SHARED_STYLES = [
        "    :root {",
    ...
    exports.normLang = normLang;
    /** Returns the string table for a language, defaulting to English. */
    function dict(lang) {
        var _a;
        return (_a = STRINGS[lang !== null && lang !== void 0 ? lang : "en"]) !== null && _a !== void 0 ? _a : STRINGS.en;
    }
    /**
     ...
     */
    function renderLangSwitch(selfUrl, lang) {
     ...
     */
    function renderRecentTicketsCard(tickets, ticketsUrl, agendaUrl, lang) {
        ...
        const cards = tickets.map(tk => {
            ...
            return [
                ...
                "        </div>",
                `        <div class="tc-name">${escapeHtml((_a = tk.name) !== null && _a !== void 0 ? _a : "—")}</div>`,
                `        <div class="tc-topic">${escapeHtml((_b = tk.topic) !== null && _b !== void 0 ? _b : "—")}</div>`,
                `        <div class="tc-date">${escapeHtml((_c = tk.date) !== null && _c !== void 0 ? _c : "—")}</div>`,
                "      </div>"
            ].join("\n");
        }).join("\n");
        return [
    ...
    function renderPage(state = {}) {
        var _a, _b, _c;
        const lang = (_a = state.lang) !== null && _a !== void 0 ? _a : "en";
        const t = dict(lang);
        const base = escapeHtml((_b = state.baseUrl) !== null && _b !== void 0 ? _b : "");
        const ticketsUrl = base + "&view=tickets";
        const agendaUrl = base + "&view=agenda";
        const recentCard = renderRecentTicketsCard((_c = state.recentTickets) !== null && _c !== void 0 ? _c : [], ticketsUrl, agendaUrl, lang);
    ...
    function renderTicketsPage(state = {}) {
        ...
        const t = dict(lang);
        const base = escapeHtml((_b = state.baseUrl) !== null && _b !== void 0 ? _b : "");
        const tickets = (_c = state.tickets) !== null && _c !== void 0 ? _c : [];
        ...
        if (tickets.length === 0) {
            ...
            rows = tickets.map(t => {
                ...
                const haystack = [t.ticketId, t.name, t.email, t.topic]
                    ...
                    .toLowerCase();
                return [
                    `<tr data-row data-search="${escapeHtml(haystack)}" data-topic="${escapeHtml((_a = t.topic) !== null && _a !== void 0 ? _a : "")}" data-date="${escapeHtml((_b = t.date) !== null && _b !== void 0 ? _b : "")}">`,
                    `  <td><code>${escapeHtml(t.ticketId)}</code></td>`,
                    `  <td>${escapeHtml((_c = t.name) !== null && _c !== void 0 ? _c : "—")}</td>`,
                    `  <td>${escapeHtml((_d = t.email) !== null && _d !== void 0 ? _d : "—")}</td>`,
                    `  <td>${escapeHtml((_e = t.topic) !== null && _e !== void 0 ? _e : "—")}</td>`,
                    `  <td>${escapeHtml((_f = t.date) !== null && _f !== void 0 ? _f : "—")}</td>`,
                    "</tr>"
                ].join("\n");
            }).join("\n");
        }
        ...
        const topics = Array.from(new Set(tickets.map(t => t.topic).filter((v) => !!v))).sort((a, b) => a.localeCompare(b));
    ...
    function renderAgendaPage(state = {}) {
        ...
        const rows = AGENDA_SCHEDULE.map(d => {
            ...
            return [
                "<tr>",
                `  <td>${escapeHtml((_a = t.dayNames[d.day]) !== null && _a !== void 0 ? _a : d.day)}</td>`,
